...
cancerstats = [0.279, 0.139, 0.106, 0.095, 0.091, 0.111, 0.132]
...
plt.xlabel('Age')
plt.ylabel('Leukaemia rates/5 years')
plt.title('Comparison of Leukaemia Probability for Different q Values')
plt.legend()
